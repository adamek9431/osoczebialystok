...
export function PRFPage() {
  useEffect(() => {
    // Setup SEO
    setupSEOMetaTags(SEO_CONFIGS.prf);
    setupOGImage(image_25909a0558481bbf84b9fdcc4c4b411887b1789a);

    // JSON-LD Schema for PRF Service (Beauty focused)
    const schemas = [{
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Zabieg Fibryną Bogatopłytkową PRF",
      "alternateName": "Platelet-Rich Fibrin",
      "description": "Najnowsza generacja regeneracji osoczem. Długotrwałe uwalnianie czynników wzrostu dla naturalnego odmłodzenia.",
      "provider": {
        "@type": "BeautySalon",
