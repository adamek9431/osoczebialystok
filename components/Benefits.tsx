...
export function Benefits() {
  ...
  return (
    <section id="korzyści" className="pt-20 pb-32 bg-gradient-to-br from-[#F5F5DC] to-white relative overflow-visible" itemScope itemType="https://schema.org/ItemList" aria-label="Korzyści zabiegów osoczem bogatopłytkowym PRP PRF Białystok">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#D4AF37]/5 to-transparent pointer-events-none z-0"></div>
      <div className="absolute top-1/4 left-1/4 w-[800px] h-[800px] bg-gradient-to-br from-[#D4AF37]/15 via-[#F4C542]/10 to-transparent rounded-full blur-[150px] opacity-40 pointer-events-none z-0"></div>
      <div className="absolute top-1/3 right-1/3 w-[700px] h-[700px] bg-gradient-to-bl from-[#D4AF37]/12 via-[#F4C542]/8 to-transparent rounded-full blur-[140px] opacity-35 pointer-events-none z-0"></div>
      <div className="absolute bottom-1/3 left-1/2 -translate-x-1/2 w-[900px] h-[700px] bg-gradient-to-tr from-[#F4C542]/15 via-[#D4AF37]/10 to-transparent rounded-full blur-[160px] opacity-38 pointer-events-none z-0"></div>
      <div className="absolute top-1/2 right-1/4 w-[600px] h-[600px] bg-gradient-to-tl from-[#D4AF37]/18 via-[#F4C542]/8 to-transparent rounded-full blur-[120px] opacity-32 pointer-events-none z-0"></div>
      <div className="absolute top-10 left-10 w-[500px] h-[500px] bg-gradient-to-br from-[#F4C542]/10 to-transparent rounded-full blur-[100px] opacity-30 pointer-events-none z-0"></div>
      <div className="absolute bottom-10 right-10 w-[600px] h-[600px] bg-gradient-to-tl from-[#D4AF37]/12 to-transparent rounded-full blur-[130px] opacity-35 pointer-events-none z-0"></div>
      <div className="absolute top-1/2 left-1/4 w-[550px] h-[550px] bg-gradient-to-r from-[#F4C542]/8 to-[#D4AF37]/10 rounded-full blur-[110px] opacity-28 pointer-events-none z-0"></div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {benefits.map((benefit, index) => {
            ...
            return (
              <motion.div 
                key={index}
                className="group relative bg-white rounded-3xl p-8 hover:shadow-2xl transition-all duration-300 border border-[#D4AF37]/10 hover:border-[#D4AF37]/30 z-10 shadow-lg"
